...
const Home = (name) => {
    ...
    <div className=''>
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center">
          ...
          {/* Title */}
          <h1 className="text-5xl text-white font-bold mb-4">Articles</h1>
 ...
 className="w-3/4 max-w-lg bg-white rounded-full text-md shadow-md px-4 translate-y-8   outline-black  mb-4">
            <div className="flex items-center">
              ...
              />
              <button className="text-gray-500 p-2 pr-0 bg-white">
                <IoIosSearch />
              </button>
            </div>
          </div>
  ...
  <ArticleFilter/>
  <ArticleGallery linkTo={"https://www.pickuplimes.com/article/how-to-reduce-food-waste-107"}/>
  <Footer></Footer>
