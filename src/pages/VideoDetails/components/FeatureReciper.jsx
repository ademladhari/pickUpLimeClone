...
const FeaturedRecipe = () => {
  ...
  <h2 className="text-sm font-bold mb-2">The Best Chocolate Chip Cookies</h2>
  <p className="text-gray-700 text-[0.7rem] italic mb-4">
  ...
  <div className="flex  ">
    <button className="bg-[#B04C35] text-white px-2 py-1 rounded-xl mx-auto text-xs transition duration-300">
      View
    </button>
  </div>
</div>
